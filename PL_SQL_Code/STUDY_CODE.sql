...
SELECT D.DEPTNO, D.DNAME, E.EMPNO, E.ENAME, E.MGR, E.SAL, E.DEPTNO "DEPTNO_1", S.LOSAL, S.HISAL, S.GRADE, M.EMPNO, M.ENAME
FROM EMP E, EMP M, DEPT D, SALGRADE S WHERE D.DEPTNO = E.DEPTNO(+) and E.MGR = M.EMPNO(+) AND E.SAL BETWEEN S.LOSAL AND S.HISAL
GROUP BY D.DEPTNO, D.DNAME,  E.EMPNO, E.ENAME, E.MGR, E.SAL, E.DEPTNO, S.LOSAL, S.HISAL, S.GRADE, M.EMPNO, M.ENAME ORDER BY D.DEPTNO;
...
SELECT * FROM DEPT D, EMP E, SALGRADE S WHERE E.SAL = S.GRADE(+) AND D.DEPTNO = E.DEPTNO(+) ;

SELECT * FROM DEPT D, EMP E, SALGRADE S WHERE D.DEPTNO = E.DEPTNO(+) AND E.SAL BETWEEN S.LOSAL AND S.HISAL;
