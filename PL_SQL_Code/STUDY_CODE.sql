...
SELECT COUNT(NVL(COMM, 0)) AS EXIST_COMM, COUNT(NVL(COMM, 0)) AS CNT FROM EMP GROUP BY NVL(COMM, 0);

SELECT COUNT(NVL(COMM, 0)) AS EXIST_COMM, COUNT(NVL(COMM, 0)) AS CNT FROM EMP GROUP BY NVL(COMM, 0);

SELECT NVL2(COMM, 0, 1) AS EXIST_COMM, COUNT(NVL2(COMM, 0, 1)) AS CNT FROM EMP GROUP BY NVL2(COMM, 0, 1);

SELECT COUNT(NVL2(COMM, 0, 1)), NVL2(COMM, 0, 1) FROM EMP GROUP BY NVL2(COMM, 0, 1);
