...
CREATE SYNONYM SDS FOR SEQ_DEPT_SEQUENCE;

CREATE SYNONYM CD FOR CHAP10HW_DEPT;
...
INSERT INTO EMPIDX(EMPNO, ENAME, JOB, DEPTNO, SAL, COMM) (SELECT EMPNO, ENAME, JOB, DEPTNO, SAL, COMM FROM EMP);

CREATE VIEW EMPIDX_OVER15K
	AS (SELECT EMPNO, ENAME, JOB, DEPTNO, SAL, NVL2(COMM, 'O', 'X') AS COMM FROM EMP_TEMP2 WHERE SAL > 1500);

DROP VIEW EMPIDX_OVER15K;

DELETE EMPIDX_OVER15K;
...
CREATE SEQUENCE DETPSEQ_SEQUENCE
INCREMENT BY 1
START WITH 1
MAXVALUE 99
MINVALUE 1
...
INSERT INTO DEPTSEQ(DEPTNO, DNAME, LOC) VALUES (DETPSEQ_SEQUENCE.NEXTVAL, 'DATABASE', 'SEOUL');
INSERT INTO DEPTSEQ(DEPTNO, DNAME, LOC) VALUES (DETPSEQ_SEQUENCE.NEXTVAL, 'WEB', 'BUSAN');
INSERT INTO DEPTSEQ(DEPTNO, DNAME, LOC) VALUES (DETPSEQ_SEQUENCE.NEXTVAL, 'MOBILE', 'ILSAN');
